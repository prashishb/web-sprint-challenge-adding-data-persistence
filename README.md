...
- Relational database is where information is stored. SQL is the language used to query relational database.

2. Why do tables need a Primary Key?

- Primary key is required to uniquely identify each entry in a database.
...
- An intermediary table that contains the primary keys of the tables it is joining.
